...
import {recordCampaignOnSentMessage} from '../../campaigns/manage_database_campaigns';
...
import { evolutionSchema } from '../../schemas';


export const sendMessage = async(file_type:string,
  ...
  image_base64:string)=>{
    ...
    if(image_base64){
      var parameters:evolutionSchema = {
        "number": target_phone,
        "mediaMessage":{
          "mediatype": file_type,
          "caption": message,
